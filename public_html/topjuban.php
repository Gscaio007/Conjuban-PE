...
echo "<li><a name=btnProfile href=index.php> <i class=fas profile></i>Página inicial</a></li>";
    
    echo "<li><a name=btnProfile href=user.php> <i class=fas fa-cog></i>Meu Perfil</a></li>";
...
;}
  ...
  <a href=# data-target=slide-out class="sidenav-trigger show-on-large"><i class=material-icons style=color:white;>menu</i></a>
    ...
    <!-- color:#203F7A; color:#c21708; font-family: Cabin Sketch;  a href="#" class="brand-logo right" > <img src="images/cbn.png" style="width: min(50vw, 120px); height:min(50vw, 35px); padding-left:15px"></a--> 
    
     <div  class="nav-wrapper container" ><a id="logo-container" href="#" class="brand-logo center"> <h4 id="h4conjuban" style="color:#fafafa;font-family: Bebas Neue; font-size:35px">CONJUBAN - PE </h4></a>
