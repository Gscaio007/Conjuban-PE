  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      ...
      <div class="row center">
        <h5 class="header col s12 light">Inscrição dos workshops (vagas reservadas!)</h5>
      </div>
      ...
      <?php // href="#"  echo"$id_post";?>
          ...
          <a class="article__item">
            ...
            <div class="article__text">
              ...
              <div class="article__author" style="font-size:14px;">Workshop: <?php //echo $autor ;?> <br> 
...
-->
            ...
            <form method="POST" action="finalinsc_reservadas.php" enctype="multipart/form-data">
