  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      ...
      <div class="row center">
        <h5 class="header col s12 light">Inscrição das palestras (vagas reservadas!)</h5>
      </div>
...
?>
      ...
      <?php // href="#"  echo"$id_post";?>
          ...
          <a class="article__item">
            ...
            <form method="POST" action="selectwork_reservadas.php" enctype="multipart/form-data">
            ...
            <input type="hidden" name="descpalestra" value=<?php $conteudo;?>> 
