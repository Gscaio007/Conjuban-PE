...
//include_once("dbconnect.php");
	...
	function enviar_email($con, $email, $rash){
		//ini_set('sendmail_from','gs.caio02@hotmail.com');

		$destinatario = $email;
        //$from = "gs.caio03@gmail.com";
		$subject = "RECUPERAR SENHA";
		$headers = "MIME-Version: 1.0\r\n";
		$headers .= 'From: CONJUBANPE-Site <gs.caio02@hotmail.com>' . "\r\n";
	...
	function verifica_rash($con, $rash){
		...
		if($total > 0){
			...
			//testemudancadesenha
				$nsenha = password_hash($_POST['senha'], PASSWORD_DEFAULT);
