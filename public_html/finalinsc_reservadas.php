...
header("Location: instrucoes_reservadas.php");
...
<nav>
    <div class="nav-wrapper" style="background-color: #c42633;">
      <div class="col s12">
        <a href="instrucoes_reservadas.php" style="padding:8px;" class="breadcrumb">Início</a>
        <a href="selectpalestra_reservadas.php" class="breadcrumb">Palestra</a>
     ...
     <div class="col s4 m5">
      <div class="card-panel white">
        <span class="black-text"> 
          <div class="row">
    <form class="col s12" method="POST" action="cadastro_reservadas.php" enctype="multipart/form-data">
      <div class="row">
